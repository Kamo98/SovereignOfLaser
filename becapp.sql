...
CREATE TABLE public.address_ent (
    id bigint NOT NULL,
...
ALTER TABLE public.address_ent OWNER TO becapp_admin;

--
-- Name: block_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.block_ent (
    id bigint NOT NULL,
...
ALTER TABLE public.block_ent OWNER TO becapp_admin;

--
-- Name: contact_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.contact_ent (
    id bigint NOT NULL,
    archive boolean,
...
ALTER TABLE public.contact_ent OWNER TO becapp_admin;

--
-- Name: contact_profile; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.contact_profile (
    id_contact bigint NOT NULL,
    id_profile bigint NOT NULL
);


ALTER TABLE public.contact_profile OWNER TO becapp_admin;

--
-- Name: custom_field_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.custom_field_ent (
    id bigint NOT NULL,
    name character varying(255),
...
ALTER TABLE public.custom_field_ent OWNER TO becapp_admin;

--
-- Name: email_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.email_ent (
    id bigint NOT NULL,
    description character varying(255),
...
ALTER TABLE public.email_ent OWNER TO becapp_admin;

--
-- Name: hibernate_sequence; Type: SEQUENCE; Schema: public; Owner: becapp_admin
--
...
ALTER TABLE public.hibernate_sequence OWNER TO becapp_admin;

--
-- Name: main_info_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.main_info_ent (
    id bigint NOT NULL,
    avatar character varying(255),
...
ALTER TABLE public.main_info_ent OWNER TO becapp_admin;

--
-- Name: phone_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.phone_ent (
    id bigint NOT NULL,
    description character varying(255),
...
ALTER TABLE public.phone_ent OWNER TO becapp_admin;

--
-- Name: profile_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.profile_ent (
    id bigint NOT NULL,
...
ALTER TABLE public.profile_ent OWNER TO becapp_admin;

--
-- Name: recent_profile_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.recent_profile_ent (
    id bigint NOT NULL,
    id_profile bigint NOT NULL,
    id_user bigint NOT NULL
);
...
ALTER TABLE public.recent_profile_ent OWNER TO becapp_admin;

--
-- Name: reference_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.reference_ent (
    id bigint NOT NULL,
    description character varying(255),
    icon integer,
    priority boolean,
...
ALTER TABLE public.reference_ent OWNER TO becapp_admin;

--
-- Name: role_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.role_ent (
    id bigint NOT NULL,
    name character varying(20)
);


ALTER TABLE public.role_ent OWNER TO becapp_admin;

--
-- Name: test1ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.test1ent (
    id bigint NOT NULL,
    name character varying(255),
...
ALTER TABLE public.test1ent OWNER TO becapp_admin;

--
-- Name: test2ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.test2ent (
    id bigint NOT NULL,
...
ALTER TABLE public.test2ent OWNER TO becapp_admin;

--
-- Name: type_custom_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.type_custom_ent (
    id bigint NOT NULL,
    name character varying(255)
);


ALTER TABLE public.type_custom_ent OWNER TO becapp_admin;

--
-- Name: user_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.user_ent (
    id bigint NOT NULL,
    email character varying(255),
    first_name character varying(255),
    last_name character varying(255),
...
ALTER TABLE public.user_ent OWNER TO becapp_admin;

--
-- Name: user_session_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.user_session_ent (
    id bigint NOT NULL,
...
ALTER TABLE public.user_session_ent OWNER TO becapp_admin;

--
-- Name: work_ent; Type: TABLE; Schema: public; Owner: becapp_admin
--

CREATE TABLE public.work_ent (
    id bigint NOT NULL,
...
ALTER TABLE public.work_ent OWNER TO becapp_admin;
...
--
-- Name: address_ent address_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.address_ent
    ADD CONSTRAINT address_ent_pkey PRIMARY KEY (id);


--
-- Name: block_ent block_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.block_ent
    ADD CONSTRAINT block_ent_pkey PRIMARY KEY (id);


--
-- Name: contact_ent contact_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.contact_ent
    ADD CONSTRAINT contact_ent_pkey PRIMARY KEY (id);


--
-- Name: contact_profile contact_profile_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.contact_profile
    ADD CONSTRAINT contact_profile_pkey PRIMARY KEY (id_contact, id_profile);


--
-- Name: custom_field_ent custom_field_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.custom_field_ent
    ADD CONSTRAINT custom_field_ent_pkey PRIMARY KEY (id);


--
-- Name: email_ent email_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.email_ent
    ADD CONSTRAINT email_ent_pkey PRIMARY KEY (id);


--
-- Name: main_info_ent main_info_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.main_info_ent
    ADD CONSTRAINT main_info_ent_pkey PRIMARY KEY (id);


--
-- Name: phone_ent phone_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.phone_ent
    ADD CONSTRAINT phone_ent_pkey PRIMARY KEY (id);


--
-- Name: profile_ent profile_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.profile_ent
    ADD CONSTRAINT profile_ent_pkey PRIMARY KEY (id);


--
-- Name: recent_profile_ent recent_profile_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.recent_profile_ent
    ADD CONSTRAINT recent_profile_ent_pkey PRIMARY KEY (id);


--
-- Name: reference_ent reference_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.reference_ent
    ADD CONSTRAINT reference_ent_pkey PRIMARY KEY (id);


--
-- Name: role_ent role_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.role_ent
    ADD CONSTRAINT role_ent_pkey PRIMARY KEY (id);


--
-- Name: test1ent test1ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.test1ent
    ADD CONSTRAINT test1ent_pkey PRIMARY KEY (id);


--
-- Name: test2ent test2ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.test2ent
    ADD CONSTRAINT test2ent_pkey PRIMARY KEY (id);


--
-- Name: type_custom_ent type_custom_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.type_custom_ent
    ADD CONSTRAINT type_custom_ent_pkey PRIMARY KEY (id);


--
-- Name: main_info_ent uk_c3kgfvt3ean4ise99fcrspvjc; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: work_ent uk_ejjtexnv9nkx3mgg7wvo45boh; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.work_ent
    ADD CONSTRAINT uk_ejjtexnv9nkx3mgg7wvo45boh UNIQUE (id_block);


--
-- Name: user_ent user_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.user_ent
    ADD CONSTRAINT user_ent_pkey PRIMARY KEY (id);


--
-- Name: user_ent user_ent_unique_email; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: user_session_ent user_session_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--

ALTER TABLE ONLY public.user_session_ent
    ADD CONSTRAINT user_session_ent_pkey PRIMARY KEY (id);


--
-- Name: work_ent work_ent_pkey; Type: CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: test2entity_key; Type: INDEX; Schema: public; Owner: becapp_admin
--

CREATE INDEX test2entity_key ON public.test2ent USING btree (key);


--
-- Name: email_ent fk5cohfkuvscfi51f15jkr97nrc; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: recent_profile_ent fk5mfw22a8fbxqij5yury7oyk91; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: user_session_ent fk6k1081qfhi8a6rnoow32ywi5k; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: contact_ent fk6o9v6dvx2k3busrodtvgoql98; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: recent_profile_ent fk7dkh0ktwoocaof9vkaix4tau8; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: phone_ent fk7uiu4fbvofh57gd3jqt07pvig; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: user_ent fk9vygtsy4k5mnooebldu4q02um; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: main_info_ent fkdc08sl9ppmdmw0y0dcccbf4qt; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: test2ent fkh1i5rogucki16f3x9xwemjhxf; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: reference_ent fkh6s41bwnncnyp1f92p1ny932y; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: custom_field_ent fkii3eun9h5klueladw9h8nmkqa; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: contact_profile fkkhmo496uambja54yxqqmdpgap; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: work_ent fkmyh19bdyqfe2l9wrmxbc0udyg; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: block_ent fknsafporc77geo1qnnnkpb20js; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: contact_profile fko0bldca1d25xyh3sjus9lijxj; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: address_ent fkovtccrjohvag6m94derraxv0j; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: custom_field_ent fkqlxoxoixieusywfdsxe95cwkj; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
...
--
-- Name: profile_ent fkrqqnr7r8rg2073uix8qnbiig7; Type: FK CONSTRAINT; Schema: public; Owner: becapp_admin
--
